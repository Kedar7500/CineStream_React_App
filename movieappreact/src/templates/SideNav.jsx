  ...
  return (
    <div className="w-[20%] h-full border-r-2 text-zinc-400 p-10">
      ...
      <nav className="flex flex-col ml-5">
        ...
        <Link to="/popular" className="hover:bg-[#6556CD] hover:text-white duration-300 rounded hover:font-bold text-xl p-4">
          <i className="mr-2 ri-bard-fill"></i>
          Popular
        </Link>
        <Link to="/movie" className="hover:bg-[#6556CD] hover:text-white duration-300 rounded hover:font-bold text-xl p-4">
          <i className="mr-2 ri-movie-2-fill"></i>
          Movies
        </Link>
        <Link to="/tvshows" className="hover:bg-[#6556CD] hover:text-white duration-300 rounded hover:font-bold text-xl p-4">
          <i className="mr-2 ri-tv-2-fill"></i>
          TV Shows
        </Link>
        <Link to="/person" className="hover:bg-[#6556CD] hover:text-white duration-300 rounded hover:font-bold text-xl p-4">
